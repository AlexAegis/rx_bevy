# [rx_core_operator_delay](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_delay)
...
```sh
cargo run -p rx_core_operator_delay --features example --example delay_operator_example
```
