# [rx_core_observable_never](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_observable_never)
...
```sh
cargo run -p rx_core_observable_never --features example --example never_example
```
