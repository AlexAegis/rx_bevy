# [rx_core_operator_first](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_first)
...
```sh
cargo run -p rx_core_operator_first --features example --example first_operator_example
```
