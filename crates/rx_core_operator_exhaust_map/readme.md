# [rx_core_operator_exhaust_map](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_exhaust_map)
...
```sh
cargo run -p rx_core_operator_exhaust_map --features example --example exhaust_map_operator_example
```
