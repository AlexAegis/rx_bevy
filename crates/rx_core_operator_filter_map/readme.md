# [rx_core_operator_filter_map](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_filter_map)
...
```sh
cargo run -p rx_core_operator_filter_map --features example --example filter_map_operator_example
```
