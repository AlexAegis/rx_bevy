# [rx_core_observable_merge](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_observable_merge)
...
```sh
cargo run -p rx_core_observable_merge --features example --example merge_example
```

```sh
cargo run -p rx_core_observable_merge --features example --example merge_subject_example
```
