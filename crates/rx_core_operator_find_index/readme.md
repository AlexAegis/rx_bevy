# [rx_core_operator_find_index](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_find_index)
...
```sh
cargo run -p rx_core_operator_find_index --features example --example find_index_operator_example
```
