# [rx_core_operator_find](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_find)
...
```sh
cargo run -p rx_core_operator_find --features example --example find_operator_example
```
