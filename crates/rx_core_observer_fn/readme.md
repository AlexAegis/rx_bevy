...
```sh
cargo run -p rx_core_observer_fn --features example --example fn_observer_example
```

```sh
cargo run -p rx_core_observer_fn --features example --example dyn_fn_observer_example
```
