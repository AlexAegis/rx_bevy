use crate::{Observer, SignalContext, SubscriptionLike};
...
/// call.
pub trait Subscriber: Observer + SubscriptionLike + SignalContext {}

impl<T> Subscriber for T where T: Observer + SubscriptionLike + SignalContext {}
