# [rx_core_operator_fallback_when_silent](https://github.com/AlexAegis/rx_bevy/tree/master/crates/rx_core_operator_fallback_when_silent)
...
```sh
cargo run -p rx_core_operator_fallback_when_silent --features example --example fallback_when_silent_operator_example
```
