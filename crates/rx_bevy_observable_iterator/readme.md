...
```sh
cargo run -p rx_bevy_observable_iterator --example into_observable_example
cargo run -p rx_bevy_observable_iterator --example iterator_example
```
