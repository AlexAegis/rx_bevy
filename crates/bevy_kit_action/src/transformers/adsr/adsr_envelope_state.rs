...
pub fn determine_phase_transition(
	previous_frame: &AdsrEnvelopePhase,
	current_frame: &AdsrEnvelopePhase,
) -> AdsrEnvelopePhaseTransition {
	match (previous_frame, current_frame) {
		(AdsrEnvelopePhase::None, AdsrEnvelopePhase::Attack) => AdsrEnvelopePhaseTransition::Start,
		(AdsrEnvelopePhase::None, AdsrEnvelopePhase::Decay) => {
			// When there is no attackTime
			AdsrEnvelopePhaseTransition::Fire
		}

		(AdsrEnvelopePhase::Attack, AdsrEnvelopePhase::Decay) => AdsrEnvelopePhaseTransition::Fire,
		(AdsrEnvelopePhase::Decay, AdsrEnvelopePhase::Sustain) => {
			AdsrEnvelopePhaseTransition::Sustain
		}
		(AdsrEnvelopePhase::Sustain, AdsrEnvelopePhase::Release) => {
			AdsrEnvelopePhaseTransition::Release
		}
		(AdsrEnvelopePhase::Release, AdsrEnvelopePhase::None) => AdsrEnvelopePhaseTransition::End,
