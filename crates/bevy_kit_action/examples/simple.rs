...
use bevy_kit_action::{
	Action, ActionContext, SocketMapPlugin, ActionPlugin, ActionStart, FromConverter,
};
...
fn main() -> AppExit {
	App::new()
		...
		.add_plugins(SocketMapPlugin::<KeyCode, ExampleFireAction, FromConverter>::default())
